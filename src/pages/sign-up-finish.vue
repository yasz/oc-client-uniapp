        ...
        <view class="w-[90vw] pt-56">
            <view class="bg-white rounded-3xl shadow-lg p-6 w-[90%] text-center text-base leading-relaxed">
                <template v-if="isTeacher">
                    <div>
                        感谢您注册成为Lifefunner"乐凡中文"平台的教师！<br />
                ...
                <template v-else>
                    <div>
                        感谢您申请或欢迎来到Lifefunner"乐凡中文"！Lifefunner使中文学习更有效、更轻松。"乐凡中文"的VIP学员我们将在查阅您提供的资料之后，予以人工回复。<br />
                        近期请留意您的邮箱，或保持电话畅通（基于您提供的联系方式）。<br />
                        <br />
                        <span class="text-sm text-gray-500">Thank you for applying to become a Lifefunner VIP
                            student/registered teacher!<br />We will reply to you manually after reviewing the
                            information you provided. Kindly pay attention to your email or ensure your phone normal
                            working in the coming days.</span>
                    </div>
                </template>
            </view>
            <button v-if="!isTeacher" class="mt-8 w-[80%] py-3 rounded-full text-white font-bold text-base bg-[#FFA53B]"
                @click="goCourses">
                返回课程
            </button>
        </view>
