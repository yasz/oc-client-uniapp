<template>
  <view class="min-h-screen bg-gray-100">
    <!-- 顶部操作栏 -->
    <view class="fixed top-0 left-0 right-0 bg-white px-4 py-3 flex justify-between items-center shadow-sm z-10">
    </view>
    ...
    <view class="pt-16 px-4">
      ...
      <view v-else-if="assignments.length === 0" class="flex justify-center items-center py-8">
        <text class="text-gray-500">暂无作业</text>
      </view>

      <view v-else class="space-y-4">
        <view v-for="assignment in assignments" :key="assignment.id" class="bg-white rounded-lg p-4 shadow-sm">
